...
#ifndef AQBANKING_JOBCREATEDATEDTRANSFER_H
#define AQBANKING_JOBCREATEDATEDTRANSFER_H
 ...
 * transaction you should call @ref AB_JobCreateDatedTransfer_GetTransaction.
 * This transaction MUST NOT contain splits.
 */
AQBANKING_API 
int AB_JobCreateDatedTransfer_SetTransaction(AB_JOB *j,
