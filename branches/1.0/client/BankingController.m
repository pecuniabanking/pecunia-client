...
-(void)awakeFromNib
{
    ...
    [transactionController addObserver: self forKeyPath: @"selectionIndex" options: 0 context: nil];
    ...
    [transactionController bind: @"selectionIndex" toObject: statementsListView withKeyPath: @"selectedRow" options: nil];
    [statementsListView bind: @"selectedRow" toObject: transactionController withKeyPath: @"selectionIndex" options: nil];
    
    [statementsListView setCellSpacing: 0];
	[statementsListView setAllowsEmptySelection: YES];
	[statementsListView setAllowsMultipleSelection: NO];
