...
-(NSString*)stringForFields: (NSArray*)fields usingDateFormatter: (NSDateFormatter*)dateFormatter
{
	...
	for(NSString *field in fields) {
		...
		if (obj) {
			...
			else if( [field isEqualToString: @"value" ] || [field isEqualToString: @"saldo" ])  { 
            ...
            // Zeilenumbruch innerhalb einer Zeile verhindern
            if (s) s = [s stringByReplacingOccurrencesOfString:@"\n" withString:@" " ];
